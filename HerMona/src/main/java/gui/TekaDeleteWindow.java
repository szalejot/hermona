...
public class TekaDeleteWindow extends JFrame {
	...
	private JButton b = new JButton("Usuń tekę");
	...
	public TekaDeleteWindow() {
		...
		JLabel l = new JLabel("Wybierz tekę do usunięcia:");
	...
	private class ButtonListener implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			...
			JOptionPane.showMessageDialog(null, "Teka o numerze " + teka.getNumer() + " została usunięta", "", JOptionPane.PLAIN_MESSAGE);
		}
