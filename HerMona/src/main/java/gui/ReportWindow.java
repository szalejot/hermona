...
public class ReportWindow extends JFrame {
	...
	public ReportWindow(String predicate) {
		...
		p.add(jList);
		p.add(new JLabel("Podaj nazwę pliku raportu:"));
	...
	private void generateReport() {
		...
		if (valList.isEmpty()) {
			JOptionPane.showMessageDialog(null, "Nie wybrano kolumn do raportu", "BŁĄD", JOptionPane.WARNING_MESSAGE);
			return;
		}
		try {
		...
		JOptionPane.showMessageDialog(null, "Zakończono generowanie raportu", "", JOptionPane.PLAIN_MESSAGE);
	}
